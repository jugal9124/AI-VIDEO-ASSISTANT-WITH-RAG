...
import os
def get_llm():
  return ChatMistralAI(model="mistral-small-latest", mistral_api_key=os.getenv("MISTRAL_API_KEY"), temperature=0.3) # type: ignore
...
def summarize(transcript: str) -> str:
  ...
  return combined_chain.invoke(combined) # type: ignore
